...
public class CircleJane extends ObjectJane {
    List<Float> centerPoint;
    Float radiusX;
    Float radiusY;
    public CircleJane(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<Float> centerPoint, Float radiusX, Float radiusY) {
