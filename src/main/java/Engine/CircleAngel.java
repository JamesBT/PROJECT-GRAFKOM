...
public class CircleAngel extends ObjectAngel {
    List<Float> centerPoint;
    Float radiusX;
    Float radiusY;
    public CircleAngel(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<Float> centerPoint, Float radiusX, Float radiusY) {
