...
public class SpongeAngel extends CircleAngel {
    float radiusZ;
    int stackCount;
    int sectorCount;
    public SpongeAngel(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<Float> centerPoint, Float radiusX, Float radiusY, Float radiusZ,
