...
public class ObjectJane extends ShaderProgram{
    ...
    List<ObjectJane> childObjectJane;
    List<Float> centerPoint;

    public List<ObjectJane> getChildObject() {
        return childObjectJane;
    }

    public void setChildObject(List<ObjectJane> childObjectJane) {
        this.childObjectJane = childObjectJane;
    }
    ...
    public ObjectJane(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, List<Vector3f> verticesColor) {
    ...
    public ObjectJane(List<ShaderModuleData> shaderModuleDataList
            , List<Vector3f> vertices
            , Vector4f color) {
        super(shaderModuleDataList);
        this.vertices = vertices;
        ...
        childObjectJane = new ArrayList<>();
        centerPoint = Arrays.asList(0f,0f,0f);
        curveVertices = new ArrayList<>();
    }
    ...
    public void draw(Camera camera, Projection projection){
        ...
        glDrawArrays(GL_POLYGON,
                0,
                vertices.size());
        for(ObjectJane child: childObjectJane){
