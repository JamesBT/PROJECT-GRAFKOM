...
//    }
    ...
    //pake lines
    //hampir sama kayak lingkaran
    public Bintang(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color,
                   double besar, double cx,double cy, List<Integer> index)
    {
        super(shaderModuleDataList, vertices, color);
        this.r = besar;
        this.cx = cx;
