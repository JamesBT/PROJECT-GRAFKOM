...
public class CircleCopy extends Object2dCopy
{
    double x, y, r, cpx, cpy;
    //constructor lingkaran(1), persegi(2), segitiga(3)
    public CircleCopy(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, double r, double cpx, double cpy, int option)
    {
    ...
    public CircleCopy(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, double r, double cpx, double cpy, double ratio, int option)
    {
        super(shaderModuleDataList, vertices, color);
        this.r = r;
        this.cpx = cpx;
